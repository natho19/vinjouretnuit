...
function vjn_register_assets() {
    wp_register_style('plugins', get_template_directory_uri() . '/assets/css/plugins.css');
    wp_register_style('style', get_template_directory_uri() . '/assets/css/style.css');

    wp_register_script('vjn-jq', get_template_directory_uri() . '/assets/js/jquery-3.6.0.min.js', [], false, true);
    wp_register_script('vjn-jq-migrate', get_template_directory_uri() . '/assets/js/jquery-migrate-3.0.0.min.js', [], false, true);
    ...
    wp_register_script('jq-isotope', get_template_directory_uri() . '/assets/js/jquery.isotope.v3.0.2.js', [], false, true);
    ...
    wp_register_script('jq-waypoints', get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', [], false, true);
    wp_register_script('owl-carousel', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', [], false, true);
    wp_register_script('jq-stellar', get_template_directory_uri() . '/assets/js/jquery.stellar.min.js', [], false, true);
    ...
    wp_enqueue_script('vjn-jq');
    wp_enqueue_script('vjn-jq-migrate');
    wp_enqueue_script('modernizr');
    wp_enqueue_script('imagesloaded');
    wp_enqueue_script('jq-isotope');
    wp_enqueue_script('pace');
    wp_enqueue_script('popper');
    wp_enqueue_script('bootstrap');
    wp_enqueue_script('scrollit');
    wp_enqueue_script('jq-waypoints');
    wp_enqueue_script('owl-carousel');
    wp_enqueue_script('jq-stellar');
...
add_action('wp_enqueue_scripts', 'vjn_register_assets');